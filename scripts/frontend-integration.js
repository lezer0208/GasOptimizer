 ...
 * This file demonstrates how to integrate Gasoptimizer with a web frontend
 */

// For React/Vue/Angular applications
export class GasoptimizerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GasoptimizerClient(provider, contractAddress);
