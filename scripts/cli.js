...
const contractABI = require("../artifacts/contracts/Gasoptimizer.sol/Gasoptimizer.json").abi;

program
    .name("gasoptimizer-cli")
    .description("CLI tool for Gasoptimizer smart contract")
    .version("1.0.0");
